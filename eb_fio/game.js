...
function updateData(types,data,cb){
  ...
  eb.send("dataUpdate", {"t":types,"d":data} , function (ar, ar_err) {
    if (ar_err == null) {
...
function InfoRequest() {
  ...
  reqData(['world'],function(Jdata) {
    ...
    /*write it back*/
     updateData( ["world"], {"world":someData}, function( ar ) {
         if(ar)
